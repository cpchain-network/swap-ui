          ...
          <div class="gridContent2">
            ...
            <div class="menu">
              ...
              <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
                ...
                <el-sub-menu index="4">
                  <template #title>{{ $t('navbar.meun4.title') }}</template>
        ...
        <div class="content1">
          ...
          <ul>
            <li v-for="connector in connectors" :key="connector.id" @click="wallconnects(connector, chainId)">
              ...
              <img  :src="connector.name == 'WalletConnect' ? img : connector.icon" alt=""   v-if="connector.name !== 'WalletConnect'">
              <span   v-if="connector.name !== 'WalletConnect'"> {{ connector.name }}</span>
            </li>
          </ul>
...
<script setup>
import { ref, onMounted, watchEffect, onBeforeUnmount, watch, computed } from 'vue';
